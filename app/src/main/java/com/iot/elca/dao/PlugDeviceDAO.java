...
public class PlugDeviceDAO {

    private static final String TABLE_NAME = "PLUG_DEVICE";
    ...
    public static List<PlugDevice> selectAllDevices(ElcaDbHelper dbHelper) {
        LinkedList<PlugDevice> devices = new LinkedList<>();
    ...
    public static PlugDevice selectDevice(ElcaDbHelper dbHelper, int id){
        //setup the query to be executed
        StringBuilder stringBuilderQuery = new StringBuilder();
    ...
    public static void insertDevice(ElcaDbHelper dbHelper, PlugDevice device) {
    ...
    public static void updateDevice(ElcaDbHelper dbHelper, PlugDevice device) {
        ContentValues contentValues = new ContentValues();
